...
- Bài này ta có bug OOB khi mà ta có thể kiểm soát idx của table.
  ...
  ![alt text](/_posts/image/image.png)

- Tiếp tục ta có bug BOF khi mà `scanf()` không giới hạn độ dài

  ![alt text](/_posts/image/image2.png)
...
![alt text](/_posts/image/image4.png)
...
![alt text](/_posts/image/image-1.png)

## Phân tích

- Bài này có bug BOF.

  ![alt text](/_posts//_posts/image/image-2.png)
